...
$string['freeplayinstructions'] = 'Think at the answer, flip the card, and control your answer. You may pull this card out from the deck or test another card. The deck is presented in a random order. Check all the deck one shot if possible.';
