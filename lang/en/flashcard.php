...
$string['dbcouldnotinsert'] = 'Could not insert flashcard_card record';
$string['dbcouldnotupdate'] = 'Could not update flashcard_card record';
$string['deck'] = 'Deck';
...
$string['erroraddingcard'] = 'Could not add card to deck';
$string['errorcouldnotbindcard'] = 'Could not bind card to user $userid deck';
$string['errorcouldnotupdatedeck'] = 'Could not update deck card';
$string['errorinvalidflashcardid'] = 'Invalid flashcard ID';
$string['errorillegaldirectaccess'] = 'Illegal direct access to this screen';
